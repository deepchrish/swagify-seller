                ...
                <div class="sw-form">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label class="control-label" for="fulladdress">Full Address
                                        <span class="text-danger"> * </span>
                                    </label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <div class="select-wrapper">
                                        <label class="control-label" for="country">Country/Region
                                            <span class="text-danger"> * </span>
                                        </label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="City" placeholder="Houston" name="City">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label class="control-label" for="phonenumber">Phone Number
                                        <span class="text-danger"> * </span>
                                    </label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label class="control-label" for="websiteurl">Personal Website or URL
                                    </label>
                                    <input id="websiteurl" type="url" class="form-control" name="websiteurl"
                                        placeholder="https://">
                                </div>
                            </div>
